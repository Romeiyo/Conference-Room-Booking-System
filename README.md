...
If you wish to view this repository locally, do the following:
- Copy project link
- Within the VScode terminal, use the command "git clone [project link]"
...
- Manage room details & Assets
- Handle recurring bookings
- Generate Usage Reports
- Allow users to cancel bookings made
- Booking requests
- Conflict prevention
